	...
	var gtk2 = ctypes.open('libgtk-x11-2.0.so.0');
	...
	var gtk_init = gtk2.declare('gtk_init', ctypes.default_abi, ctypes.void_t, ctypes.int.ptr, ctypes.char.ptr.ptr.ptr);
	...
	//g_threads_init(null);
	gdk_threads_init();
	gtk_init(ctypes.int(0).address(), null);
	gdk_threads_enter();
